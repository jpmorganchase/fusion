...
class FusionHTTPFileSystem(HTTPFileSystem):  # type: ignore
    ...
    def _compute_checksum_from_data(self, data: bytes, algorithm: str, is_multipart: bool = False) -> str:  # noqa: PLR0911, PLR0912
        ...
        if algorithm == "CRC32":
            ...
            crc_int = self._compute_crc64nvme_int(data)
            crc_bytes = crc_int.to_bytes(8, byteorder="big")

            if is_multipart:
                composite_crc = self._compute_crc64nvme_int(crc_bytes)
    ...
    def _compute_crc64nvme_int(self, data: bytes) -> int:
        """Compute CRC64NVME from raw data bytes and return return as integer."""
        ...
        crc_final = crc ^ 0xFFFFFFFFFFFFFFFF
        return crc_final
