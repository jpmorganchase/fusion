...
df = pd.DataFrame([
    {
        "Report/Process Name": "Monthly Ops Risk",
        "Report/Process Description": "Operational risk KPIs",
        "Frequency": "Monthly",
        "Category": "Risk",
        "Sub Category": "Operations",
        "businessDomain": "CDAO Office",
        "Regulatory Designated": "Yes",                     # gets converted to True
        "ownerNode_name": "110437",
        "ownerNode_type": "Application (SEAL)",
        "publisherNode_name": "110465",
        "publisherNode_type": "Intelligent Solutions",
        "publisherNode_publisherNodeIdentifier": "seal:app:123",
        "sourceSystem": {"id": "SYS1", "type": "Custom"}    # optional dict passes through
    },
    {
        "Report/Process Name": "Treasury Liquidity",
        "Report/Process Description": "Daily liquidity metrics",
        "Frequency": "Daily",
        "Category": "Finance",
        "Sub Category": "Treasury",
        "businessDomain": "CDAO Office",
        "Regulatory Designated": "No",                      # gets converted to False
        "ownerNode_name": "220001",
        "ownerNode_type": "Application (SEAL)",
        "publisherNode_name": "220002",
        "publisherNode_type": "Intelligent Solutions",
        "publisherNode_publisherNodeIdentifier": "seal:app:999"
    },
])
