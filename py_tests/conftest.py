...
EXAMPLE_RESOURCE = "JPMC:URI:RS-97834-Fusion-PROD"
EXAMPLE_AUTH_URL = "https://authe.mysite.com/as/token.oauth2"
EXAMPLE_HTTP_PROXY = "http://myproxy.com:8080"
EXAMPLE_HTTPS_PROXY = "http://myproxy.com:8081"
...
def example_creds_dict() -> dict[str, Any]:
    return {
        ...
        "auth_url": EXAMPLE_AUTH_URL,
        "proxies": {
            "http": EXAMPLE_HTTP_PROXY,
            "https": EXAMPLE_HTTPS_PROXY,
        },
    }
