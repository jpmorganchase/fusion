...
class TestChecksumComputation:
    ...
    def test_compute_checksum_crc32c(self, fs_with_checksum: FusionHTTPFileSystem) -> None:
        ...
        test_data = b"Hello, World!"
        crc_value = aws_checksums.crc32c(test_data)
        expected = base64.b64encode(crc_value.to_bytes(4, byteorder="big")).decode("ascii")
...
class TestChecksumIntegration:
    ...
    def test_stream_single_file_with_checksum_validation_success(self, fs_with_checksum: FusionHTTPFileSystem) -> None:
    ...
    def test_stream_single_file_with_checksum_validation_failure(self, fs_with_checksum: FusionHTTPFileSystem) -> None:
    ...
    def test_stream_single_file_with_unsupported_algorithm(self, fs_with_checksum: FusionHTTPFileSystem) -> None:
    ...
    async def test_async_download_single_file_with_checksum(self, fs_with_checksum: FusionHTTPFileSystem) -> None:
        ...
        with tempfile.NamedTemporaryFile(delete=False) as tmp_file:
            ...
            with patch.object(fs_with_checksum, "_fetch_range_to_memory", new_callable=AsyncMock) as mock_fetch:
